  ...
  return (
    <Comment.Group>
      ...
      <Form reply onSubmit={() => createReview()}>
        <Form.TextArea onChange={e => setInput(e.target.value)} value={input} required />
        <Button content="Add Reply" labelPosition="left" icon="edit" color={'teal'} />
      </Form>
     <Emoji onClick={(emoji,event )=> setInput(prev=> prev += emoji.native)}/>
